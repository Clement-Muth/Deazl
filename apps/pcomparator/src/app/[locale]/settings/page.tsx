    ...
    <main className="container flex-col">
      ...
      <div className="max-w-4xl mx-auto px-4 pb-6">
        <div className="space-y-4 md:space-y-6">
          ...
          {/* Shopping Optimization Section */}
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div className="px-4 py-3 md:px-6 md:py-4 border-b border-gray-200 bg-gradient-to-r from-green-50 to-green-100">
              <h2 className="text-base md:text-lg font-semibold text-gray-900">
            ...
            <div className="p-4 md:p-6 space-y-4 md:space-y-6">
              <SettingsOptimalPricing userId={session?.user?.id!} />
              <div className="border-t border-gray-200 pt-4 md:pt-6">
                <SettingsFavoriteStores userId={session?.user?.id!} />
              </div>
            </div>
          </div>
