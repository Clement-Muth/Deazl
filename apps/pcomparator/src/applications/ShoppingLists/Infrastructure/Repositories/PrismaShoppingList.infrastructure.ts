...
import { InfrastructureError } from "~/applications/Shared/Infrastructure/Core/Errors/Infrastructure.error";
...
import { ShoppingListInfraSchema } from "../Schemas/ShoppingList.schema";
